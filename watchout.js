...
d3.select("svg").selectAll('circle')
  .data(enemies).enter().append("svg:circle").attr("class","enemy")
  .text(function(d,i){return d.id + " " + d.x + " " + d.y})
...
setInterval(function(){
  ...
  // Render to the page
  d3.selectAll('circle', '.enemy').data(enemies).transition().duration(gameOptions.gameSpeedTime)
    .attr({
      cx : function(enemy) { return enemy.x }, //
      cy : function(enemy) { return enemy.y}
    })
